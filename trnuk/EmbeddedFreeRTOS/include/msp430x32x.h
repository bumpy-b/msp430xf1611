 ...
 * MSP430x11x family header
 *
 * (c) 2002 by M. P. Ashton <data@ieee.org>
 * Originally based in part on work by Texas Instruments Inc.
 *
 * $Id: msp430x32x.h,v 1.7 2005/08/17 14:28:46 coppice Exp $
 */
...
#define ADC_VECTOR          10	    /* 0xFFEA ADC */
